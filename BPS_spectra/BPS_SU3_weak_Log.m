%% BPS spectra in SU3 - weak coupling with Log degeneracies
...
load ('SU3DTweakLog.mat')
point_cloud = SU3DTweakLog;
size(point_cloud)
...
options.filename = 'SU3DTweakLogBarcodes';
options.max_filtration_value = max_filtration_value;
options.max_dimension = max_dimension - 1;
options.side_by_side = true;
options.caption='SU3 weak Log';
